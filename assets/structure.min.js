                        ...
                        case "department":
                            ...
                            if (item.submissive && item.submissive[0]) {
                                ...
                                source +=
                                    ...
                                    genDepartmentStructure(_structure, "division") +
                                    "</div>";
                            }
                            break;
                        case "division":
                            ...
                            if (item.submissive && item.submissive[0]) {
                                ...
                                source +=
                                    ...
                                    genDivisionStructure(_structure2, "profile") +
                                    "</div>";
                            }
                            break;
                        default:
                    ...
                    function genStructureManagement() {
                        ...
                        if (item.submissive || item.submissive.length > 0) {
                            ...
                            if (parentRole) {
                                ...
                                for (var _i3 in item.submissive) {
                                    source += genManager.call(this, item.submissive[_i3]);
                                }
                        }
                        return source;
                    }
